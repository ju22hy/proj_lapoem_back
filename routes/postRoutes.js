...
const { joinUser, loginUser, logoutUser, saveAgreement } = require('../controllers/authController'); // authController를 사용
const communityController = require('../controllers/communityController');
const { registerBestSeller } = require('../controllers/postBestBook');
const { postBookReview, verifyToken } = require('../controllers/BookDetailController');
